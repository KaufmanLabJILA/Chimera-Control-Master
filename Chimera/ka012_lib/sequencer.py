...
class sequencer:
    ...
    def dac_seq_write_points(self, byte_len, byte_buf, num_snapshots):
        ...
        # points0.append(DAC_seq_point(address=0,  time=0,  start=32768,incr=0,chan=0, clr_incr=1))
        # points0.append(DAC_seq_point(address=1,  time=1,  start=32768,incr=0,chan=1, clr_incr=1))
        # points0.append(DAC_seq_point(address=2,  time=2,  start=32768,incr=0,chan=2, clr_incr=1))
        # points0.append(DAC_seq_point(address=3,  time=3,  start=32768,incr=0,chan=3, clr_incr=1))
        # points0.append(DAC_seq_point(address=4,  time=4,  start=32768,incr=0,chan=4, clr_incr=1))
        # points0.append(DAC_seq_point(address=5,  time=5,  start=32768,incr=0,chan=5, clr_incr=1))
        # points0.append(DAC_seq_point(address=6,  time=6,  start=32768,incr=0,chan=6, clr_incr=1))
        # points0.append(DAC_seq_point(address=7,  time=7,  start=32768,incr=0,chan=7, clr_incr=1))
        # points0.append(DAC_seq_point(address=8,  time=8,  start=32768,incr=0,chan=8, clr_incr=1))
        # points0.append(DAC_seq_point(address=9,  time=9,  start=32768,incr=0,chan=9, clr_incr=1))
        # points0.append(DAC_seq_point(address=10, time=10, start=32768,incr=0,chan=10,clr_incr=1))
        # points0.append(DAC_seq_point(address=11, time=11, start=32768,incr=0,chan=11,clr_incr=1))
        # points0.append(DAC_seq_point(address=12, time=12, start=32768,incr=0,chan=12,clr_incr=1))
        # points0.append(DAC_seq_point(address=13, time=13, start=32768,incr=0,chan=13,clr_incr=1))
        # points0.append(DAC_seq_point(address=14, time=14, start=32768,incr=0,chan=14,clr_incr=1))
        # points0.append(DAC_seq_point(address=15, time=15, start=32768,incr=0,chan=15,clr_incr=1))
        # points0.append(DAC_seq_point(address=16, time=32000, start=32768,incr=0,chan=0,clr_incr=1))
        # points0.append(DAC_seq_point(address=17, time=756000, start=32768,incr=1844917,chan=0,clr_incr=0))
        # points0.append(DAC_seq_point(address=18, time=1920112, start=49152,incr=0,chan=0,clr_incr=1))
        # points0.append(DAC_seq_point(address=19, time=0,  start=0,incr=0,chan=0,clr_incr=0))
        # #step 100 LSB per 10 us
        # points1.append(DAC_seq_point(address=0,  time=0,  start=32768,incr=0,chan=0, clr_incr=1))
        # points1.append(DAC_seq_point(address=1,  time=1,  start=32768,incr=0,chan=1, clr_incr=1))
        # points1.append(DAC_seq_point(address=2,  time=2,  start=32768,incr=0,chan=2, clr_incr=1))
        # points1.append(DAC_seq_point(address=3,  time=3,  start=32768,incr=0,chan=3, clr_incr=1))
        # points1.append(DAC_seq_point(address=4,  time=4,  start=32768,incr=0,chan=4, clr_incr=1))
        # points1.append(DAC_seq_point(address=5,  time=5,  start=32768,incr=0,chan=5, clr_incr=1))
        # points1.append(DAC_seq_point(address=6,  time=6,  start=32768,incr=0,chan=6, clr_incr=1))
        # points1.append(DAC_seq_point(address=7,  time=7,  start=32768,incr=0,chan=7, clr_incr=1))
        # points1.append(DAC_seq_point(address=8,  time=8,  start=32768,incr=0,chan=8, clr_incr=1))
        # points1.append(DAC_seq_point(address=9,  time=9,  start=32768,incr=0,chan=9, clr_incr=1))
        # points1.append(DAC_seq_point(address=10, time=10, start=32768,incr=0,chan=10,clr_incr=1))
        # points1.append(DAC_seq_point(address=11, time=11, start=32768,incr=0,chan=11,clr_incr=1))
        # points1.append(DAC_seq_point(address=12, time=12, start=32768,incr=0,chan=12,clr_incr=1))
        # points1.append(DAC_seq_point(address=13, time=13, start=32768,incr=0,chan=13,clr_incr=1))
        # points1.append(DAC_seq_point(address=14, time=14, start=32768,incr=0,chan=14,clr_incr=1))
        # points1.append(DAC_seq_point(address=15, time=15, start=32768,incr=0,chan=15,clr_incr=1))
        # points1.append(DAC_seq_point(address=16, time=1870000, start=32768,incr=737899,chan=0,clr_incr=0))
        # points1.append(DAC_seq_point(address=17, time=3034112, start=39321,incr=0,chan=0,clr_incr=1))
        # points1.append(DAC_seq_point(address=18, time=0,  start=0,incr=0,chan=0,clr_incr=0))
        #
        # for point in points0:
        #     for key, value in point.__dict__.iteritems():
        #         if (not isinstance(value,int)):
...
if __name__ == "__main__":
    ...
    byte_buf_dio = 't00000010_b0000000000000001\0' \
    			   't00000A00_b0000000000000000\0' \
    			   't00030d40_b0000000000000001\0' \
    			   't00F61a80_b0000000000000000\0'
    ...
    byte_buf_dac = 't00008100_c0000_s00.000_e00.000_d00000000\0' \
    			   't000b8d80_c0000_s00.000_e05.000_d0011c350\0' \
                   't001c8d80_c0001_s00.000_e02.000_d0011c350\0'
