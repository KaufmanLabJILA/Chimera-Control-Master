...
class DAC_ramp_tester:
  ...
  def dac_seq_write_points(self):
    ...
    points0.append(DAC_seq_point(address=0,time=0,start=0,steps=2175,incr=122880,chan=0))
    ...
    points1.append(DAC_seq_point(address=0,time=1,start=256*128,steps=20000,incr=40960,chan=0))
