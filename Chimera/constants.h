...
/// File Locations
	...
	const std::string TWEEZER_PAINT_AMPLITUDE_LUT_FILE_LOCATION = PROJECT_LOCATION + "\\Tweezer LUT\\" + "paintAmpLUT_48x48_with_interp.npy";
	const std::string TWEEZER_PAINT_MASK_LUT_FILE_LOCATION = PROJECT_LOCATION + "\\Tweezer LUT\\" + "paintEnLUT.npy";
